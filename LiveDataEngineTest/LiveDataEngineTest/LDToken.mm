...
+(NSDictionary*)getToken:(NSString*)key pid:(NSString*)pid uid:(NSString*)uid{
    ...
    NSString * secert = [LDToken base64DecodingString:key];
    NSString * time = [NSString stringWithFormat:@"%@",[NSNumber numberWithLongLong:[[NSDate date] timeIntervalSince1970]]];
    NSString * source_step1 = [NSString stringWithFormat:@"%@:%@:%@",pid,uid,time];
    NSData * h256Data_step2 = [LDToken hmacSHA256WithSecret:secert content:source_step1];
